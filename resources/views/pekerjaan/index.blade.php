...
@section('title', 'Pekerjaan Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Pekerjaan</span>
        <small>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Pekerjaan <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('pekerjaan.create')}}"><i class="fal fa-plus-circle">
                        </i>
...
<script>
    $(document).ready(function(){
       ...
       var table = $('#datatable').DataTable({
            ...
            {data: 'satker_id', name: 'satker_id'},
            {data: 'tahun_mulai', name: 'tahun_mulai'},
            {data: 'tahun_selesai', name: 'tahun_selesai'},
