...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Pelaksanaan Fisik</i></span></h2>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3 mb-3">
                            ...
                            <div id="rencana" class="input-group">
                                {{ Form::text('rencana',null,['placeholder' => 'rencana','class' => 'form-control '.($errors->has('rencana') ? 'is-invalid':''),'required'])}}
                        ...
                        <div class="form-group col-md-3 mb-3">
                            ...
                            <div id="realisasi" class="input-group">
                                {{ Form::text('realisasi',null,['placeholder' => 'realisasi','class' => 'form-control '.($errors->has('realisasi') ? 'is-invalid':''),'required'])}}
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        0.00
                                    </span>
                        ...
                        <div class="form-group col-md-3 mb-3">
                            ...
                            <div id="deviasi" class="input-group">
                                {{ Form::text('deviasi',null,['placeholder' => 'deviasi','class' => 'form-control '.($errors->has('deviasi') ? 'is-invalid':''),'required'])}}
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        0.00
                                    </span>
