...
@section('title', 'Jenis Pekerjaan Edit')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$jenker->nama}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['jenker.update',$jenker->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('nama','Nama Lengkap',['class' => 'required form-label'])}}
                        {{ Form::text('nama',$jenker->nama,['placeholder' => 'Nama Lengkap','class' => 'form-control '.($errors->has('nama') ? 'is-invalid':''),'required'])}}
                        @if ($errors->has('nama'))
