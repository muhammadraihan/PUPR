...
@section('title', 'Jenis Pekerjaan Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Jenis Pekerjaan</span>
        <small>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Jenis Pekerjaan <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('jenker.create')}}"><i class="fal fa-plus-circle">
                        </i>
