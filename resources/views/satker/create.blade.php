        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <!-- <div class="form-group col-md-4 mb-3">
                        {{ Form::label('created_by','Created By',['class' => 'required form-label'])}}
                        {{ Form::text('created_by',null,['placeholder' => 'Created By','class' => 'form-control '.($errors->has('created_by') ? 'is-invalid':''),'required'])}}
