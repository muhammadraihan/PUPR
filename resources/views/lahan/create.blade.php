...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Dokumen Pembebasan Lahan</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => 'lahan.store','method' => 'POST','class' =>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        {{ Form::text('kebutuhan',null,['placeholder' => 'Kebutuhan','class' => 'form-control '.($errors->has('kebutuhan') ? 'is-invalid':''),'required'])}}
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        {{ Form::text('sudah_bebas',null,['placeholder' => 'Sudah Bebas','class' => 'form-control '.($errors->has('sudah_bebas') ? 'is-invalid':''),'required'])}}
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        {{ Form::text('belum_bebas',null,['placeholder' => 'Belum Bebas','class' => 'form-control '.($errors->has('belum_bebas') ? 'is-invalid':''),'required'])}}
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        {{ Form::text('permasalahan',null,['placeholder' => 'Permasalahan','class' => 'form-control '.($errors->has('permasalahan') ? 'is-invalid':''),'required'])}}
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        {{ Form::text('tindak_lanjut',null,['placeholder' => 'Tindak Lanjut','class' => 'form-control '.($errors->has('tindak_lanjut') ? 'is-invalid':''),'required'])}}
