...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Pembebasan Lahan</span>
        <small>
            Module for manage Data Pembebasan Lahan.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Pembebasan Lahan <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    @can('add_kontrak')
                    <a class="nav-link active" href="{{route('lahan.create')}}"><i class="fal fa-plus-circle">
                        </i>
    ...
    $(document).ready(function(){
        $('#datatable').DataTable({
            ...
            "columns": [
                ...
                {data: 'kebutuhan',width:'*'},
                {data: 'sudah_bebas',width:'*'},
                {data: 'belum_bebas',width:'*'},
                {data: 'dokumentasi_id',width:'*'},
                {data: 'permasalahan',width:'*'},
                {data: 'tindak_lanjut',width:'*'},
