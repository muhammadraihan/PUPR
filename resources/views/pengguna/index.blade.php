...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Pengguna</span>
        <small>
            Module for manage Pengguna.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Daftar <span class="fw-300"><i>Pengguna</i></span>
                </h2>
                <div class="panel-toolbar">
                    @can('add_pengguna')
                    <a class="nav-link active" href="{{route('pengguna.create')}}"><i class="fal fa-plus-circle">
                        </i>
    ...
    $(document).ready(function(){
        $('#datatable').DataTable({
            ...
            "columns": [
                ...
                {data: 'name',width:'*'},
                {data: 'email',width:'*'},
                {data: 'jabatan_id',width:'*'},
                {data: 'satker_id',width:'*'},
                {data: 'wilayah',width:'*'},
