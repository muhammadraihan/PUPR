...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Pengguna</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => 'pengguna.store','method' => 'POST','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {!! Form::select('jabatan', $jabatans, '', ['class' => 'select2 form-control'.($errors->has('jabatan') ? 'is-invalid':''), 'required'
